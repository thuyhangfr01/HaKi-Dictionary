...
public class WordDetailVEActivity extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WordDetailVEActivity.this, MainActivity.class);
    ...
    public void loadData(){
        AndroidNetworking.get("http://ec2-3-144-36-186.us-east-2.compute.amazonaws.com:3030/api/dictVieEng/id/{id}")
    ...
    public void addData(){
        ...
        try {
            ...
            jsonObject.put("idDicVE", wordId);

        } catch (JSONException e) {
            e.printStackTrace();
        }

        AndroidNetworking.post("http://ec2-3-144-36-186.us-east-2.compute.amazonaws.com:3030/api/yourWordVieEng/addYourWordVieEng")
