...
public class HistoryEVFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_history_e_v, container, false);
    ...
    private void getListHistoryEV() {
        AndroidNetworking.get("http://ec2-3-144-36-186.us-east-2.compute.amazonaws.com:3030/api/historyEngVie/" + userId)
                .build()
